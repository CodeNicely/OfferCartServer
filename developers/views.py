...
def developers(request):
	if request.method=='GET':
		...
		company_data['about']="We Code StartUps \n\n CodeNicely is a Raipur based Startup.\n CodeNicely is providing all IT Solutions. We are a team of some geeky geeks from NIT , Raipur and we Love Coding"
		company_data['companyImage']="http://192.168.0.111:8000/static/images/developers/codenicely_full_logo.png"
